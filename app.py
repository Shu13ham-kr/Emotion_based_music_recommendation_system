...
st.markdown(
    ...
    .stApp header .toolbar {
        background-color: #00CED1; 
        padding: 0px;
        margin-top: -60px;
    }
    .stApp header .toolbar .dropdown {
        display: none;
    }
    .stApp header .toolbar .fullScreenButton {
        display: none;
        text-align:center;
    }
    .stApp header .toolbar .rerunButton {
        display: none;
        text-align:center;
    }
    </style>
...
st.write(
    ...
    <div style="background-color: #000000; padding: 10px;">
        <h1 style="color: #A020F0; text-align: center;">SINHGAD INSTITUTE OF TECHNOLOGY</h1>
        <h2 style="color: yellow; text-align: center;">EMOTION BASED MUSIC RECOMMENDATION SYSTEM</h2>
    </div>
    """,
    unsafe_allow_html=True
)
st.markdown("<h5 style='text-align: bottom; color:808080;text-align:center ;'><b>Made by: <br>Shubham Kumar | Mohith Mudaliyar | Aman Khan | Anurag Mundada</b></h5>", unsafe_allow_html=True)
